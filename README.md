...
## Environments
- Preview: https://main--setup-recaptcha--lovelymandal16.hlx.page/
- Live: https://main--setup-recaptcha--lovelymandal16.hlx.live/
...
1. Open the `setup-recaptcha` directory in your favorite IDE and start coding :)
